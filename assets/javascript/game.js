...
switch(user) {
    case 'BARK':
        ...
        if(loud === 'YES' || scary === 'YES') {
            alert("You only need one of the two! You let out a loud and scary 'RAH RAH RAH' right in the dog's face with your loud speaker and the mean old dog ran away! I bet it'll never try and jump out at you ever again!");
        } else {
            alert("Your bark isn't loud OR scary? What kind of dog are you, any way? The dog thinks you're a chump and bites your face off. Sorry—you lose, Harriet.");
        }
        break;
    case 'THROW':
        ...
        if(cheese === 'YES' || cheeseType === 'YES') {
            alert("You throw an entire wheel of tasty cheese at the dog and it gobbles up in three big aaomps, wags its tail, and asks if it can be your friend on DogBook.");
        } else {
